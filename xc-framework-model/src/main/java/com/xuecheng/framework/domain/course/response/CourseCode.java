...
public enum CourseCode implements ResultCode {
    ...
    COURSE_PUBLISH_CREATE_INDEX_ERROR(false, 31004, "创建课程索引失败！"),
    ...
    COURSE_MEDIA_TEACHPLAN_ISNULL(false,31103,"选择课程计划为空！"),
    COURSE_MEDIA_TEACHPLAN_GRADEERROR(false,31104,"选择课程的级别错误！");
